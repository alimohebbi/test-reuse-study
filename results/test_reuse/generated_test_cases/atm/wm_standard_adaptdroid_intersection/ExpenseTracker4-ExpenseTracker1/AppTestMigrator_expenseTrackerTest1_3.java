...
public class AppTestMigrator_expenseTrackerTest1_3 {
    ...
    public void apptestmigrator_expensetrackertest1_3() {
        ...
        onView(withId(R.id.onboarding_screen3_initial_amount_money_tv)).check(matches(withText("$")));
        ...
        onView(withText("(That was easy, huh?)")).check(matches(withText("(That was easy, huh?)")));
