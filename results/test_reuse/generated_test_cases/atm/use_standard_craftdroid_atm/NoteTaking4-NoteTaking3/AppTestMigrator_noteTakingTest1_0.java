...
public class AppTestMigrator_noteTakingTest1_0 {
    ...
    @Test
    public void apptestmigrator_notetakingtest1_0() {
        ...
        onView(allOf(withId(R.id.title), withText("Import from device"))).check(matches(withText("Import from device")));
