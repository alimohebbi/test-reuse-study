...
public class AppTestMigrator_shoppingListTest10_1 {
    ...
    public void apptestmigrator_shoppinglisttest10_1() {
        ...
        onView(withId(R.id.edDescription)).perform(replaceText("Weekly grocery shopping"), closeSoftKeyboard());
        ...
        onView(allOf(withId(R.id.timeShoppingList), withText("11:32 PM"))).check(matches(withText("11:32 PM")));
