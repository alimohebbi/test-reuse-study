...
public class AppTestMigrator_easyBudgetTest10_1 {
    ...
    public void apptestmigrator_easybudgettest10_1() {
        onView(withId(R.id.tv_total_income)).perform(longClick());
        ...
        onView(withId(R.id.et_category)).perform(replaceText("45"), closeSoftKeyboard());
        
        pressBack();
        
        onView(withXPath("/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.support.v4.widget.DrawerLayout/android.view.ViewGroup")).check(matches(withText("Add expense")));
