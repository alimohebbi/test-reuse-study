...
public class AppTestMigrator_expenseTrackerTest10_3 {
    ...
    public void apptestmigrator_expensetrackertest10_3() {
        ...
        onView(withText("Add exchange rate")).check(matches(withText("AED")));
        
        onView(withContentDescription("Navigate up")).perform(click());
        
        onView(withText("Exchange rates")).check(matches(isDisplayed()));
        
        onView(withId(R.id.btn_add_exchange_rate)).perform(click());
        
        onView(withXPath("/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.LinearLayout[2]/android.widget.LinearLayout/android.widget.Spinner/android.widget.TextView")).check(matches(isDisplayed()));
        
        onView(withXPath("/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup")).check(matches(withText("AED")));
