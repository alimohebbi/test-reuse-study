...
public class AppTestMigrator_shoppingListTest10_1 {
    ...
    public void apptestmigrator_shoppinglisttest10_1() {
        ...
        onView(withId(R.id.list_notes)).perform(replaceText("Weekly grocery shopping"), closeSoftKeyboard());
        
        onView(withText("Okay")).perform(click());
        
        onView(withText("This list does not contain any products")).check(matches(withText("This list does not contain any products")));
