...
public class AppTestMigrator_writeilyTest1_1 {
    ...
    public void apptestmigrator_writeilytest1_1() {
        ...
        onView(withText("Are you sure you want to backup current notes?")).check(matches(allOf(withText("Are you sure you want to backup current notes?"), isDisplayed(), isEnabled())));
