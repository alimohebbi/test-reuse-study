...
public class AppTestMigrator_shoppingListTest11_2 {
    ...
    public void apptestmigrator_shoppinglisttest11_2() {
        ...
        onView(withId(R.id.decor_content_parent)).check(matches(allOf(withText("list1"), isDisplayed(), isEnabled())));
        ...
        onView(withId(R.id.textview_prod_quantity)).check(matches(allOf(isDisplayed(), withText("Main"), isEnabled())));
