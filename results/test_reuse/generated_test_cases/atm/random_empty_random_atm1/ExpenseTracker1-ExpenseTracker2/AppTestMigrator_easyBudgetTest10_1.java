...
public class AppTestMigrator_easyBudgetTest10_1 {
    ...
    public void apptestmigrator_easybudgettest10_1() {
        ...
        onView(withId(R.id.expense_value)).perform(replaceText("Entertainment"), closeSoftKeyboard());
        
        onView(withId(R.id.expense_value)).perform(replaceText("45"), closeSoftKeyboard());
        
        pressBack();
        
        onView(withXPath("/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup")).check(matches(withText("Total of month expenses")));
