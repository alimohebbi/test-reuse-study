...
public class AppTestMigrator_shoppingListTest11_2 {
    ...
    public void apptestmigrator_shoppinglisttest11_2() {
        ...
        onView(withXPath("/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup")).check(matches(allOf(withText("Add Shopping List"), isDisplayed(), isEnabled())));
        ...
        onView(withId(R.id.percentTextView)).check(matches(allOf(isDisplayed(), withText("just now"), isEnabled())));
