...
public class AppTestMigrator_expensesTest3_1 {
    ...
    public void apptestmigrator_expensestest3_1() {
        ...
        onView(withId(R.id.et_import_data)).perform(replaceText("45"), closeSoftKeyboard());
        
        onView(withId(R.id.et_import_data)).perform(replaceText("restaurant"), closeSoftKeyboard());
