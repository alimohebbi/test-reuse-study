...
public class AppTestMigrator_writeilyTest1_1 {
    ...
    public void apptestmigrator_writeilytest1_1() {
        ...
        onView(allOf(withId(R.id.catalog_view_row_$_textview_title), withText("As grid view"))).perform(click());
        ...
        onView(withXPath("/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout/android.view.ViewGroup")).check(matches(allOf(withText("Pocket Note"), isDisplayed(), isEnabled())));
