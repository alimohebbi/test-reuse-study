...
public class AppTestMigrator_easyBudgetTest10_1 {
    ...
    public void apptestmigrator_easybudgettest10_1() {
        ...
        onView(withId(R.id.tv_date)).perform(longClick());
        ...
        onView(withText("Sun, Apr 3")).perform(click());
        
        onView(withText("Sun, Apr 3")).perform(click());
        
        onView(withText("2022")).perform(click());
        
        onView(withXPath("/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.DatePicker/android.widget.LinearLayout/android.widget.LinearLayout/android.widget.TextView")).perform(click());
        ...
        onView(withId(R.id.et_category)).perform(replaceText("Entertainment"), closeSoftKeyboard());
        
        onView(withId(R.id.et_price)).perform(replaceText("45"), closeSoftKeyboard());
        
        pressBack();
        
        onView(withText("Week")).check(matches(withText("Add income")));
