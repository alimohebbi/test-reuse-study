...
public class AppTestMigrator_shoppingListTest10_1 {
    ...
    public void apptestmigrator_shoppinglisttest10_1() {
        ...
        onView(withId(R.id.shoppingListDescriptionEditText)).perform(replaceText("grocery"), closeSoftKeyboard());
        
        onView(withContentDescription("Navigate up")).perform(click());
        
        onView(withXPath("/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.support.v4.widget.DrawerLayout/android.view.ViewGroup")).check(matches(withText("You have no shopping lists. Add one using the button below.")));
