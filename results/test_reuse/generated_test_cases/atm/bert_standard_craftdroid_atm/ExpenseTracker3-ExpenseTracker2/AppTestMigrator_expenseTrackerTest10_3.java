...
public class AppTestMigrator_expenseTrackerTest10_3 {
    ...
    public void apptestmigrator_expensetrackertest10_3() {
        ...
        onView(withText("Education")).check(matches(withText("Education")));
        ...
        onView(withText("Education")).check(matches(isDisplayed()));
        
        onView(withText("Payments")).perform(click());
        
        onView(withText("Payments")).check(matches(isDisplayed()));
        
        onView(withText("Payments")).check(matches(withText("Payments")));
