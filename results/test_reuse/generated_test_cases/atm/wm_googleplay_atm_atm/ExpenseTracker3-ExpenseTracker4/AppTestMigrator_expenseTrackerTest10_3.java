...
public class AppTestMigrator_expenseTrackerTest10_3 {
    ...
    public void apptestmigrator_expensetrackertest10_3() {
        ...
        onView(withId(R.id.tv_period)).check(matches(withText("All time")));
        ...
        onView(withId(R.id.til_title)).check(matches(isDisplayed()));
        
        onView(withId(R.id.et_price)).perform(replaceText("500"), closeSoftKeyboard());
        
        onView(withId(R.id.action_done)).perform(click());
        
        onView(withId(R.id.til_price)).check(matches(isDisplayed()));
