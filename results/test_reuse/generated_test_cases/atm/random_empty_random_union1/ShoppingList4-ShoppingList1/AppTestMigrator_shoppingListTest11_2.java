...
public class AppTestMigrator_shoppingListTest11_2 {
    ...
    public void apptestmigrator_shoppinglisttest11_2() {
        ...
        onView(withId(R.id.empty_listview_textview)).check(matches(allOf(isDisplayed(), withText("You have no shopping lists. Add one using the button below."), isEnabled())));
