...
public class AppTestMigrator_expenseTrackerTest1_3 {
    ...
    public void apptestmigrator_expensetrackertest1_3() {
        ...
        onView(withId(R.id.onboarding_screen3_next_button)).check(matches(withText("$")));
        
        onView(withId(R.id.onboarding_screen3_initial_amount_et)).perform(replaceText("1500"), closeSoftKeyboard());
        
        onView(withId(R.id.onboarding_screen3_next_button)).perform(click());
        
        onView(withId(R.id.onboarding_screen4_next_button)).check(matches(withText("(That was easy, huh?)")));
        ...
        onView(withId(R.id.balance_amount)).perform(replaceText("General"), closeSoftKeyboard());
        
        onView(withText("Cancel")).perform(click());
        
        onView(withId(R.id.budgetLineAmount)).check(matches(withText("EasyBudget")));
