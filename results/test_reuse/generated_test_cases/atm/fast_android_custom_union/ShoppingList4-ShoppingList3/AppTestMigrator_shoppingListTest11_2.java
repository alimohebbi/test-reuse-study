...
public class AppTestMigrator_shoppingListTest11_2 {
    ...
    public void apptestmigrator_shoppinglisttest11_2() {
        ...
        onView(withId(R.id.decor_content_parent)).check(matches(allOf(withText("New Shopping List"), isDisplayed(), isEnabled())));
        ...
        onView(withId(R.id.textinput_counter)).check(matches(allOf(isDisplayed(), withText("New List"), isEnabled())));
