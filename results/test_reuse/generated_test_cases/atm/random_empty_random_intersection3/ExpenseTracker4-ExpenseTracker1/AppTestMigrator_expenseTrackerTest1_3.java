...
public class AppTestMigrator_expenseTrackerTest1_3 {
    ...
    public void apptestmigrator_expensetrackertest1_3() {
        ...
        onView(withXPath("/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.view.View[3]")).check(matches(withText("Let's get to know each other!")));
        
        onView(withXPath("/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.view.View[4]")).check(matches(withText("Step 2: How much do you currently have on your account?
