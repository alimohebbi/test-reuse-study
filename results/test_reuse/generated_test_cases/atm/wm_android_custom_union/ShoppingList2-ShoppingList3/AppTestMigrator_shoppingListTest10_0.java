...
public class AppTestMigrator_shoppingListTest10_0 {
    ...
    public void apptestmigrator_shoppinglisttest10_0() {
        onView(withId(R.id.btn_skip)).check(matches(withText("With this app you can create and manage shopping lists. Lists can be prioritized, have deadlines, reminders and more.")));
