...
public class AppTestMigrator_shoppingListTest11_2 {
    ...
    public void apptestmigrator_shoppinglisttest11_2() {
        ...
        onView(withId(R.id.product_name)).perform(replaceText("item1"), closeSoftKeyboard());
        
        onView(withId(R.id.product_button_plus)).perform(click());
        
        onView(withText("Okay")).check(matches(allOf(isDisplayed(), withText("Okay"), isEnabled())));
