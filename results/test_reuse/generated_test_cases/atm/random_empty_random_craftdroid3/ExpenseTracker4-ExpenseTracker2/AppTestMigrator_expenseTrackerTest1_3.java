...
public class AppTestMigrator_expenseTrackerTest1_3 {
    ...
    public void apptestmigrator_expensetrackertest1_3() {
        ...
        onView(withId(R.id.expense_value)).perform(replaceText("1500"), closeSoftKeyboard());
        ...
        onView(withText("Thu, May 12")).perform(click());
        ...
        onView(withText("Others")).check(matches(withText("Transportation")));
