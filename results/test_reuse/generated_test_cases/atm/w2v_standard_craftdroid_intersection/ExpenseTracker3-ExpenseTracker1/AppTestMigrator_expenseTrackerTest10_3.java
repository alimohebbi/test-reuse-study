...
public class AppTestMigrator_expenseTrackerTest10_3 {
    ...
    public void apptestmigrator_expensetrackertest10_3() {
        ...
        onView(withText("Add recurring expense/income")).check(matches(withText("Add recurring expense/income")));
        
        onView(withText("Add recurring expense/income")).check(matches(isDisplayed()));
