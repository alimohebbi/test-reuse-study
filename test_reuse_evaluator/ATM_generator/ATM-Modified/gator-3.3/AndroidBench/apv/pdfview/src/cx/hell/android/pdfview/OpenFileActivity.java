...
// #endif
	...
	// these are for options menu items
	...
	// these are for context menu items
	private MenuItem aboutMenuItem2 = null;
	private MenuItem gotoPageMenuItem2 = null;
	private MenuItem rotateLeftMenuItem2 = null;
	private MenuItem rotateRightMenuItem2 = null;
	private MenuItem findTextMenuItem2 = null;
	private MenuItem clearFindTextMenuItem2 = null;
	private MenuItem chooseFileMenuItem2 = null;
	private MenuItem optionsMenuItem2 = null;
...
//     	this.textReflowMenuItem = menu.add(R.string.text_reflow);
    ...
    public void onCreateContextMenu(ContextMenu menu, View v, ContextMenuInfo menuInfo) {
        ...
        /* I'm sorry... */
        this.gotoPageMenuItem2 = menu.add(R.string.goto_page);
        this.rotateRightMenuItem2 = menu.add(R.string.rotate_page_left);
        this.rotateLeftMenuItem2 = menu.add(R.string.rotate_page_right);
        if (this.pagesView.getFindMode()) {
            this.clearFindTextMenuItem2 = menu.add(R.string.clear_find_text);
        }
        this.chooseFileMenuItem2 = menu.add(R.string.choose_file);
        this.optionsMenuItem2 = menu.add(R.string.options);
        
// #ifdef pro
//      this.tableOfContentsMenuItem = menu.add(R.string.table_of_contents);
//      this.textReflowMenuItem = menu.add(R.string.text_reflow);
// #endif
        this.findTextMenuItem2 = menu.add(R.string.find_text);
        this.aboutMenuItem2 = menu.add(R.string.about);
    }
    ...
    public boolean onContextItemSelected(MenuItem menuItem) {
        // kill me
        if (menuItem == this.aboutMenuItem2) {
            Intent intent = new Intent();
            intent.setClass(this, AboutPDFViewActivity.class);
            this.startActivity(intent);
        } else if (menuItem == this.gotoPageMenuItem2) {
            this.showGotoPageDialog();
        } else if (menuItem == this.rotateLeftMenuItem2) {
            this.pagesView.rotate(-1);
        } else if (menuItem == this.rotateRightMenuItem2) {
            this.pagesView.rotate(1);
        } else if (menuItem == this.findTextMenuItem2) {
            this.showFindDialog();
        } else if (menuItem == this.clearFindTextMenuItem2) {
            this.clearFind();
        } else if (menuItem == this.chooseFileMenuItem2) {
            startActivity(new Intent(this, ChooseFileActivity.class));
        } else if (menuItem == this.optionsMenuItem2) {
            startActivity(new Intent(this, Options.class));
// #ifdef pro
//      } else if (menuItem == this.tableOfContentsMenuItem) {
//          Outline outline = this.pdf.getOutline();
