...
public class ex_item_activity extends ActionBarActivity implements AdapterView.OnItemSelectedListener{

    EditText editValue;
    EditText editName;
    MyExDBHandler dbHandler;
    Spinner spinner;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbHandler = new MyExDBHandler(this, null, null, 1);
    ...
    public void DeleteButtonClicked(View v){
        ...
        Toast.makeText(this, R.string.expense_deleted_text, Toast.LENGTH_LONG).show();
        super.onBackPressed();
