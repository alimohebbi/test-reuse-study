...
public class expense_activity extends ActionBarActivity implements AdapterView.OnItemSelectedListener{


    EditText editText;
    EditText valueText;
    TextView textView;
    MyExDBHandler exDbHandler;
    Spinner spinner;
    TextView total_expense_view;

    String selected_time_item;

    //NYTT
    ListView list;
    CustomExAdapter adapter;
    public  expense_activity CustomListView = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exDbHandler = new MyExDBHandler(this, null, null, 1);
        total_expense_view = (TextView)findViewById(R.id.total_expense_view);
        //printDatabase();
        ...
        list= ( ListView )findViewById( R.id.expenseList );  // List defined in XML ( See Below )

        /**************** Create Custom Adapter *********/
        adapter=new CustomExAdapter( CustomListView, CustomListViewValuesArr,res );
        list.setAdapter( adapter );

        //SLUTT PÅ NYTT
        //********************************************
        printEditableDatabase();
        updateDailyMoneyExpenses();
    ...
    public void setListData() {
        ...
        String dbString = exDbHandler.databaseToString();
    ...
    public void onItemClick(int mPosition)
    {
        ...
        Intent intent = new Intent(expense_activity.this, ex_item_activity.class);
    ...
    public void AddButtonClicked(View v){
        ...
        if(input == null || input.trim().equals("") || input2 == null || input2.trim().equals("")){
            ...
            Expenses expense = new Expenses((editText.getText().toString()).replace("\n", "").replace("\r", ""), Double.parseDouble(valueText.getText().toString()),selected_time_item);
            exDbHandler.addExpense(expense);
            //printDatabase();
            printEditableDatabase();
    ...
    public void updateDailyMoneyExpenses(){
        String[] items = exDbHandler.databaseValuesAndIntervalToString().split("\\r?\\n");
        ...
        if(!items[0].equals("")){
            ...
            editor.putFloat(getString(R.string.daily_expenses),dailyMoney);
            editor.apply();
            System.out.println("TOTAL EXPENSES: "+total+"\n Daily expenses: "+dailyMoney);
            total_expense_view.setText(correctFormatOfFloat(total)+" "+getString(R.string.spinner_title));
            ...
            SharedPreferences.Editor editor=sharedPref.edit();
            editor.putFloat(getString(R.string.daily_expenses),0);
            editor.apply();
        }
