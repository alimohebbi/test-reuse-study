...
#      topackage=$(echo $activitytolaunch | awk 'BEGIN{FS=OFS="."} NF--')
      ...
      dbPath=$root"/db.json"
      # dbPath="/home/amohebbi/applications/neo4j/remote-data/db.json" 
      # scp $root"/db.json" amohebbi@star-cloud.inf.usi.ch:/home/amohebbi/applications/neo4j/remote-data/db.json
      if [ -f $dbPath ]; then
