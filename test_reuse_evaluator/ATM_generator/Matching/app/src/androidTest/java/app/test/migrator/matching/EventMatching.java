...
public class EventMatching {
    ...
    private String sendRestRequest(String json) throws IOException {
        Request request = new Request.Builder()
                .url("http://10.0.2.2:7474/db/data/transaction/commit")
...
//                            event.getTargetElement().addAtrribute("activity", activityNames.next());
    ...
    private void addOriginalText(UiNode node) {
        String originalText = node.getAttribute("text");
        if (originalText == null)
            originalText = "";
        node.addAtrribute("original_text", "*" + originalText);
    }
