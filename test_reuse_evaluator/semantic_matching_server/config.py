...
class Config(object):
    ...
    @property
    def thresholds(self):
        return os.path.join(ROOT_DIR, self._get_property('thresholds'))
    ...
    def ground_truth(self):
        return os.path.join(ROOT_DIR, self._get_property('ground_truth'))
    ...
    @property
    def query_log(self):
        return os.path.join(ROOT_DIR, self._get_property('query_log'))
