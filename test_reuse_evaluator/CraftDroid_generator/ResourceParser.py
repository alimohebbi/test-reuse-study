...
class ResourceParser:
    """
    Get information from sa_info folder. map pf widget to ids. name of widgets to their text. widget layouts.
    It only considers layout widgets that are one of @WIDGET_TYPES_FOR_LAYOUT list.
    From folder sa_info only uses res/values/strings & res/values/public & res/layout.
    """
    ...
    def extract_pkg(self):
        ...
        assert pkg
        return pkg
    #creates maps for widget name to ids and vice versa
...
# map of widget name to its text
