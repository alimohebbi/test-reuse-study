...
public class AppTestMigrator_shoppingListTest11_2 {
    ...
    public void apptestmigrator_shoppinglisttest11_2() {
        ...
        onView(withId(R.id.main_activity_toolbar)).check(matches(allOf(withText("list1"), isDisplayed(), isEnabled())));
        ...
        onView(withId(R.id.shoppingListNameTextView)).check(matches(allOf(isDisplayed(), withText("list1"), isEnabled())));
