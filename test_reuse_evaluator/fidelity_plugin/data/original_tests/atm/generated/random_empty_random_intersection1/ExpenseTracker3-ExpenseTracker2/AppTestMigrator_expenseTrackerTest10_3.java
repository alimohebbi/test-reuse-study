...
public class AppTestMigrator_expenseTrackerTest10_3 {
    ...
    public void apptestmigrator_expensetrackertest10_3() {
        ...
        onView(withText("Total")).check(matches(withText("$0.00")));
        ...
        onView(withId(R.id.expense_value)).perform(replaceText("uber"), closeSoftKeyboard());
        ...
        onView(withText("Wed, May 11")).perform(click());
        ...
        onView(withId(R.id.expense_value)).perform(replaceText("500"), closeSoftKeyboard());
        
        onView(withId(R.id.expense_value)).perform(click());
        
        onView(withXPath("/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout/android.view.ViewGroup/android.widget.ImageButton")).check(matches(isDisplayed()));
