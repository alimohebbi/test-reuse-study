...
public class AppTestMigrator_easyBudgetTest10_1 {
    ...
    public void apptestmigrator_easybudgettest10_1() {
        ...
        onView(withXPath("/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout[2]/android.support.v4.widget.DrawerLayout/android.widget.ListView/android.widget.TextView[4]")).check(matches(withText("EXPENSES")));
