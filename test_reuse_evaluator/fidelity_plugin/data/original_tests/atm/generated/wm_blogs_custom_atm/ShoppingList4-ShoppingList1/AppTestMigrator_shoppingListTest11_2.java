...
public class AppTestMigrator_shoppingListTest11_2 {
    ...
    public void apptestmigrator_shoppinglisttest11_2() {
        ...
        onView(withXPath("/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout[2]/android.widget.LinearLayout/android.widget.LinearLayout/android.widget.LinearLayout/android.widget.ListView/android.widget.LinearLayout[3]/android.widget.RelativeLayout/android.widget.TextView")).check(matches(allOf(withText("Description"), isDisplayed(), isEnabled())));
        
        onView(withText("Include list name")).perform(click());
        
        onView(withText("Include list description")).perform(click());
        ...
        onView(allOf(withId(R.id.design_menu_item_text), withText("Rate me"))).check(matches(allOf(isDisplayed(), withText("Rate me"), isEnabled())));
