...
public class AppTestMigrator_shoppingListTest11_2 {
    ...
    public void apptestmigrator_shoppinglisttest11_2() {
        ...
        onView(withId(R.id.toolbar)).check(matches(allOf(withText("Add Shopping List"), isDisplayed(), isEnabled())));
        ...
        onView(withId(R.id.main_activity_toolbar)).check(matches(allOf(isDisplayed(), isEnabled())));
