...
public class AppTestMigrator_expenseTrackerTest10_3 {
    ...
    public void apptestmigrator_expensetrackertest10_3() {
        ...
        onView(withText("(That was easy, huh?)")).check(matches(withText("1. Add recurring expenses and incomes (salary, rent, bills…)
        ...
        onView(withText("SAT")).check(matches(isDisplayed()));
        ...
        onView(withText("THU")).check(matches(isDisplayed()));
