...
public class AppTestMigrator_expenseTrackerTest1_3 {
    ...
    public void apptestmigrator_expensetrackertest1_3() {
        ...
        onView(allOf(withId(R.id.currency_cell_title_tv), withText("CA$ - Canadian Dollar"))).check(matches(withText("Go with $")));
        ...
        onView(withId(R.id.budgetLineAmount)).check(matches(withText("SUN")));
