...
public class AppTestMigrator_shoppingListTest11_2 {
    ...
    public void apptestmigrator_shoppinglisttest11_2() {
        ...
        onView(withId(R.id.shoppingListNameTextView)).check(matches(allOf(isDisplayed(), isEnabled())));
        ...
        onView(withText("Your shopping lists")).check(matches(allOf(isDisplayed(), isEnabled())));
