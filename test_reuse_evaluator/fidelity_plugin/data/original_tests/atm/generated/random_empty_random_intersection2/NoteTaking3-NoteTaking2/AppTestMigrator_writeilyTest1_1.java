...
public class AppTestMigrator_writeilyTest1_1 {
    ...
    public void apptestmigrator_writeilytest1_1() {
        ...
        onView(withId(R.id.bodyEdit)).perform(click());
        
        openActionBarOverflowOrOptionsMenu(getInstrumentation().getTargetContext());
        
        onView(allOf(withId(R.id.title), withText("Hide note body in list"))).check(matches(allOf(withText("Note font size"), isDisplayed(), isEnabled())));
