...
public class AppTestMigrator_shoppingListTest11_2 {
    ...
    public void apptestmigrator_shoppinglisttest11_2() {
        ...
        onView(allOf(withId(R.id.textView4), withText("... see list details?"))).perform(click());
        ...
        onView(withId(R.id.textview_prod_quantity)).perform(click());
        
        onView(withId(R.id.reminder_bar)).perform(click());
        
        onView(withId(R.id.fab_delete_lists)).perform(click());
        ...
        onView(withId(R.id.list_dialog_checkbox)).perform(click());
