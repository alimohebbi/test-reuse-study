...
public class AppTestMigrator_expenseTrackerTest10_3 {
    ...
    public void apptestmigrator_expensetrackertest10_3() {
        ...
        onView(withId(R.id.fab_new_recurring_expense)).check(matches(isDisplayed()));
        ...
        onView(withId(R.id.calendar_month_year_textview)).check(matches(isDisplayed()));
        
        onView(withId(R.id.calendar_month_year_textview)).check(matches(withText("APRIL 2022")));
