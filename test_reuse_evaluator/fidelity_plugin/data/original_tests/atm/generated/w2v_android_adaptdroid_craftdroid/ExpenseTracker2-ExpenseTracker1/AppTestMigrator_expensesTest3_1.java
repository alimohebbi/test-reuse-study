...
public class AppTestMigrator_expensesTest3_1 {
    ...
    public void apptestmigrator_expensestest3_1() {
        ...
        onView(withId(R.id.select_currency_recycler_view)).perform(actionOnItemAtPosition(6, click()));
        
        onView(allOf(withId(R.id.currency_cell_title_tv), withText("CHF - Swiss Franc"))).perform(click());
        ...
        onView(withId(R.id.amount_edittext)).perform(replaceText("45"), closeSoftKeyboard());
        
        onView(withId(R.id.description_edittext)).perform(replaceText("restaurant"), closeSoftKeyboard());
