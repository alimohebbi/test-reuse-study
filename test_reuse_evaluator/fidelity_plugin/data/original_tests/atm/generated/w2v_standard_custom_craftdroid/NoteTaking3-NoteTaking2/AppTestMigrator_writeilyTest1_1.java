...
public class AppTestMigrator_writeilyTest1_1 {
    ...
    public void apptestmigrator_writeilytest1_1() {
        ...
        onView(withXPath("/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.view.View")).check(matches(allOf(withText("Press '+' to add new note"), isDisplayed(), isEnabled())));
