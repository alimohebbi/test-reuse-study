...
public class AppTestMigrator_expensesTest3_1 {
    ...
    public void apptestmigrator_expensestest3_1() {
        ...
        onView(withId(R.id.onboarding_screen3_initial_amount_et)).perform(replaceText("45"), closeSoftKeyboard());
        ...
        onView(withXPath("/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout[2]/android.widget.FrameLayout/android.widget.LinearLayout/android.support.v7.widget.RecyclerView/android.widget.RelativeLayout/android.view.View")).perform(click());
        
        onView(withText("Edit income")).perform(click());
