...
public class AppTestMigrator_expenseTrackerTest10_3 {
    ...
    public void apptestmigrator_expensetrackertest10_3() {
        ...
        onView(withId(R.id.et_buy)).perform(replaceText("uber"), closeSoftKeyboard());
        
        onView(withId(R.id.action_done)).perform(click());
        
        onView(withId(R.id.toolbar)).check(matches(isDisplayed()));
        
        onView(withId(R.id.et_buy)).perform(replaceText("500"), closeSoftKeyboard());
        
        onView(withId(R.id.action_done)).perform(click());
        
        onView(withText("Convert from")).check(matches(isDisplayed()));
