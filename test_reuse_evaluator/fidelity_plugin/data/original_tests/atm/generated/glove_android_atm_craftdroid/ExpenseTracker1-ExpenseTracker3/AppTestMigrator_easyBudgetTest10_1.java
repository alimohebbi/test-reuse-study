...
public class AppTestMigrator_easyBudgetTest10_1 {
    ...
    public void apptestmigrator_easybudgettest10_1() {
        ...
        onView(withId(R.id.input_amount)).perform(replaceText("Entertainment"), closeSoftKeyboard());
        
        onView(withId(R.id.input_amount)).perform(replaceText("45"), closeSoftKeyboard());
        
        pressBack();
        
        onView(withId(R.id.current_money)).check(matches(withText("DAILY AMOUNT:")));
