...
public class AppTestMigrator_shoppingListTest11_2 {
    ...
    public void apptestmigrator_shoppinglisttest11_2() {
        ...
        onView(withId(R.id.search_input_text)).perform(replaceText("item1"), closeSoftKeyboard());
        
        onView(withId(R.id.fab_new_product)).perform(click());
        
        onView(withId(R.id.textinput_counter)).check(matches(allOf(isDisplayed(), withText("0 / 40"), isEnabled())));
