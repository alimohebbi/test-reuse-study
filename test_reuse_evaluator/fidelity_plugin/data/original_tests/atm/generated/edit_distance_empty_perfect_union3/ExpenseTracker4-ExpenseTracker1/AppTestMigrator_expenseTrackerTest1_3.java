...
public class AppTestMigrator_expenseTrackerTest1_3 {
    ...
    public void apptestmigrator_expensetrackertest1_3() {
        ...
        onView(withId(R.id.amount_edittext)).perform(replaceText("1500"), closeSoftKeyboard());
        
        onView(withId(R.id.save_expense_fab)).perform(click());
        
        onView(withId(R.id.description_edittext)).perform(replaceText("GRA"), closeSoftKeyboard());
        
        onView(withId(R.id.save_expense_fab)).perform(click());
        
        onView(withId(R.id.expense_title)).check(matches(withText("GRA")));
