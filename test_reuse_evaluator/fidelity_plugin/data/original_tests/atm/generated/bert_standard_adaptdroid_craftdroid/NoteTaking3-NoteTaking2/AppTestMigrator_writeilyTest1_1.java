...
public class AppTestMigrator_writeilyTest1_1 {
    ...
    public void apptestmigrator_writeilytest1_1() {
        ...
        onView(withId(R.id.search_src_text)).perform(replaceText("note"), closeSoftKeyboard());
        
        onView(withId(R.id.search_src_text)).perform(replaceText("something"), closeSoftKeyboard());
        
        onView(withId(R.id.search_close_btn)).perform(click());
        
        openActionBarOverflowOrOptionsMenu(getInstrumentation().getTargetContext());
        
        onView(allOf(withId(R.id.title), withText("Rate app"))).check(matches(allOf(withText("Restore notes"), isDisplayed(), isEnabled())));
