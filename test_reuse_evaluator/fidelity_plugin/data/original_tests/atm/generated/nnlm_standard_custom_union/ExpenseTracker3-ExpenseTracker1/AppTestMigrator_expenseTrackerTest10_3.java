...
public class AppTestMigrator_expenseTrackerTest10_3 {
    ...
    public void apptestmigrator_expensetrackertest10_3() {
        ...
        onView(allOf(withId(R.id.currency_cell_title_tv), withText("CA$ - Canadian Dollar"))).check(matches(isDisplayed()));
        ...
        onView(withText("1. Add recurring expenses and incomes (salary, rent, bills…)
        
        2. Don't forget to add your daily expenses and incomes during the day")).check(matches(isDisplayed()));
