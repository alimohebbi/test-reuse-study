...
public class AppTestMigrator_expenseTrackerTest10_3 {
    ...
    public void apptestmigrator_expensetrackertest10_3() {
        ...
        onView(withText("Account")).check(matches(withText("Date")));
        
        onView(withId(R.id.et_title)).perform(replaceText("uber"), closeSoftKeyboard());
        
        onView(withContentDescription("Navigate up")).perform(click());
        
        onView(withId(R.id.btn_add_expense)).check(matches(isDisplayed()));
        ...
        onView(withId(R.id.btn_add_expense)).check(matches(withText("Add income")));
