...
public class AppTestMigrator_shoppingListTest10_0 {
    ...
    public void apptestmigrator_shoppinglisttest10_0() {
        onView(withText("With this app you can create and manage shopping lists. Lists can be prioritized, have deadlines, reminders and more.")).check(matches(withText("Welcome")));
