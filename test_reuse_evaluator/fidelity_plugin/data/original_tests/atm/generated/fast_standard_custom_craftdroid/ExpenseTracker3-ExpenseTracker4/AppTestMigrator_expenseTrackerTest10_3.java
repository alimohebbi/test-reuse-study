...
public class AppTestMigrator_expenseTrackerTest10_3 {
    ...
    public void apptestmigrator_expensetrackertest10_3() {
        ...
        onView(withXPath("/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.support.v4.widget.DrawerLayout/android.widget.FrameLayout/android.support.v7.widget.RecyclerView/android.widget.FrameLayout[2]/android.view.View")).perform(click());
        
        onView(withId(R.id.btn_add_income)).perform(click());
        
        onView(withText("Week")).check(matches(withText("Week")));
        ...
        onView(withText("Total expense")).check(matches(isDisplayed()));
        
        onView(withText("Total expense")).check(matches(withText("Backup/Restore")));
