...
public class AppTestMigrator_expenseTrackerTest10_3 {
    ...
    public void apptestmigrator_expensetrackertest10_3() {
        ...
        onView(withText("The concept is simple: You enter your recurring and daily expenses and incomes and the app keeps track of how much money you have, had and will have at any given moment.
        
        It's as simple as that.")).check(matches(withText("The concept is simple: You enter your recurring and daily expenses and incomes and the app keeps track of how much money you have, had and will have at any given moment.
        ...
        onView(withId(R.id.balance_amount)).perform(replaceText("uber"), closeSoftKeyboard());
