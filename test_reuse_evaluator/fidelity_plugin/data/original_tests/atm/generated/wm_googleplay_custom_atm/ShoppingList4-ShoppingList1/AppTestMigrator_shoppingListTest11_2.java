...
public class AppTestMigrator_shoppingListTest11_2 {
    ...
    public void apptestmigrator_shoppinglisttest11_2() {
        ...
        onView(withText("Include list name")).check(matches(allOf(withText("Include list name"), isDisplayed(), isEnabled())));
        ...
        onView(withText("Include list name")).check(matches(allOf(isDisplayed(), withText("Include list name"), isEnabled())));
