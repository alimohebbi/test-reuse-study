...
public class AppTestMigrator_expensesTest3_1 {
    ...
    @Test
    public void apptestmigrator_expensestest3_1() {
        ...
        onView(withId(R.id.balance_amount)).perform(replaceText("45"), closeSoftKeyboard());
        
        onView(withId(R.id.balance_amount)).perform(replaceText("restaurant"), closeSoftKeyboard());
