...
public class AppTestMigrator_expenseTrackerTest10_3 {
    ...
    public void apptestmigrator_expensetrackertest10_3() {
        ...
        onView(withText("Total income")).check(matches(withText("Total income")));
        
        onView(withText("Total income")).perform(click());
        
        onView(withText("Total income")).check(matches(isDisplayed()));
        
        onView(withText("Total income")).perform(click());
        
        onView(withText("Short summary")).check(matches(isDisplayed()));
        
        onView(withText("Short summary")).check(matches(withText("Short summary")));
