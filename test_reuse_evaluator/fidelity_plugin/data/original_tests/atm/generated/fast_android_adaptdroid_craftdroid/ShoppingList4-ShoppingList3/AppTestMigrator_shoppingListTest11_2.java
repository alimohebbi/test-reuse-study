...
public class AppTestMigrator_shoppingListTest11_2 {
    ...
    public void apptestmigrator_shoppinglisttest11_2() {
        ...
        onView(withId(R.id.recyclerView)).check(matches(allOf(withText("Shopping List"), isDisplayed(), isEnabled())));
        ...
        onView(withId(R.id.fab_new_list)).check(matches(isDisplayed()));
