...
public class AppTestMigrator_expenseTrackerTest10_3 {
    ...
    public void apptestmigrator_expensetrackertest10_3() {
        ...
        onView(withId(R.id.et_import_data)).perform(replaceText("uber"), closeSoftKeyboard());
        ...
        onView(withId(R.id.et_import_data)).perform(replaceText("500"), closeSoftKeyboard());
        
        onView(withContentDescription("Navigate up")).perform(click());
        
        onView(withText("Week")).check(matches(isDisplayed()));
        
        onView(withText("Total expense")).check(matches(withText("Week")));
