...
public class AppTestMigrator_shoppingListTest11_2 {
    ...
    public void apptestmigrator_shoppinglisttest11_2() {
        ...
        onView(withId(R.id.item_name_edit_text)).perform(replaceText("item1"), closeSoftKeyboard());
        
        onView(withId(R.id.quantity_plus_button)).perform(click());
        
        onView(withId(R.id.addShoppingListButton)).check(matches(allOf(isDisplayed(), withText("Save"), isEnabled())));
