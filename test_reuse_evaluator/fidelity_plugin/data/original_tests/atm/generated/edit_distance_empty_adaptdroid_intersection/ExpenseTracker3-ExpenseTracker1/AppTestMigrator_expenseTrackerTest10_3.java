...
public class AppTestMigrator_expenseTrackerTest10_3 {
    ...
    public void apptestmigrator_expensetrackertest10_3() {
        ...
        onView(withText("Get a sum-up of your expenses and incomes of the month and see how much you saved.")).check(matches(isDisplayed()));
        ...
        onView(withId(R.id.balance_amount)).perform(replaceText("500"), closeSoftKeyboard());
