...
public class AppTestMigrator_shoppingListTest11_2 {
    ...
    public void apptestmigrator_shoppinglisttest11_2() {
        ...
        onView(withId(R.id.textview_stats_title)).check(matches(allOf(withText("Price vs. Month"), isDisplayed(), isEnabled())));
        ...
        onView(withText("Price")).check(matches(allOf(isDisplayed(), withText("Price"), isEnabled())));
