...
public class AppTestMigrator_shoppingListTest11_0 {
    ...
    public void apptestmigrator_shoppinglisttest11_0() {
        onView(withXPath("/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.widget.LinearLayout/android.widget.TextView[2]")).check(matches(allOf(withText("With this app you can create and manage shopping lists. Lists can be prioritized, have deadlines, reminders and more."), isDisplayed(), isEnabled())));
