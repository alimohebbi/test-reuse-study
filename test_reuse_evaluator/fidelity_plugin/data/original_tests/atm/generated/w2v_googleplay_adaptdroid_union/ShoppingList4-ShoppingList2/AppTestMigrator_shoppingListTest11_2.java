...
public class AppTestMigrator_shoppingListTest11_2 {
    ...
    public void apptestmigrator_shoppinglisttest11_2() {
        ...
        onView(withId(R.id.edUnitValue)).perform(replaceText("item1"), closeSoftKeyboard());
        
        onView(withId(R.id.action_done)).perform(click());
        
        onView(withXPath("/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout/android.view.ViewGroup/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.ImageView[2]")).check(matches(isDisplayed()));
