...
public class AppTestMigrator_expenseTrackerTest1_3 {
    ...
    public void apptestmigrator_expensetrackertest1_3() {
        ...
        onView(withId(R.id.label2)).perform(click());
        
        onView(withId(R.id.label2)).perform(click());
        
        onView(withId(R.id.label)).perform(click());
        
        onView(withId(R.id.editName)).perform(replaceText("GRA"), closeSoftKeyboard());
        
        onView(withId(R.id.editValue)).perform(replaceText("General"), closeSoftKeyboard());
