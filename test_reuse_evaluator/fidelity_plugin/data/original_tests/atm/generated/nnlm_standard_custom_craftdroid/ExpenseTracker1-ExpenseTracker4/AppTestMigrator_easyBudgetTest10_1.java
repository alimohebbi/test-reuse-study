...
public class AppTestMigrator_easyBudgetTest10_1 {
    ...
    public void apptestmigrator_easybudgettest10_1() {
        ...
        onView(withXPath("/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.LinearLayout/android.view.ViewGroup/android.widget.ImageButton")).perform(longClick());
        ...
        onView(withText("Sat, Apr 3")).perform(click());
        ...
        onView(withText("Sat, Apr 9")).perform(click());
        ...
        onView(withText("Fri, Apr 9")).perform(click());
        ...
        onView(withId(R.id.et_price)).perform(replaceText("Entertainment"), closeSoftKeyboard());
