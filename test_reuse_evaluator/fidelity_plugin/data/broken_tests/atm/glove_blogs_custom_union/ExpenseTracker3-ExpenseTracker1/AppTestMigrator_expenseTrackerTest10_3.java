...
public class AppTestMigrator_expenseTrackerTest10_3 {
    ...
    public void apptestmigrator_expensetrackertest10_3() {
        ...
        onView(withText("Thank you for using EasyBudget, and welcome :)")).check(matches(isDisplayed()));
        
        onView(withText("Thank you for using EasyBudget, and welcome :)")).check(matches(withText("1. Add recurring expenses and incomes (salary, rent, bills…)
