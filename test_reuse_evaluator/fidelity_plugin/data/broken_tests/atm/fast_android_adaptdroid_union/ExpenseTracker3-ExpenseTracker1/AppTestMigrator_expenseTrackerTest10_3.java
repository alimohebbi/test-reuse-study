...
public class AppTestMigrator_expenseTrackerTest10_3 {
    ...
    public void apptestmigrator_expensetrackertest10_3() {
        ...
        onView(withId(R.id.onboarding_screen1_top_layout)).check(matches(withText("Welcome to EasyBudget")));
        ...
        onView(withId(R.id.titleDividerNoCustom)).check(matches(isDisplayed()));
