...
public class AppTestMigrator_shoppingListTest11_2 {
    ...
    public void apptestmigrator_shoppinglisttest11_2() {
        ...
        onView(withId(R.id.textinput_counter)).check(matches(allOf(withText("Notes"), isDisplayed(), isEnabled())));
        ...
        onView(withId(R.id.textinput_counter)).check(matches(allOf(isDisplayed(), withText("Notes"), isEnabled())));
