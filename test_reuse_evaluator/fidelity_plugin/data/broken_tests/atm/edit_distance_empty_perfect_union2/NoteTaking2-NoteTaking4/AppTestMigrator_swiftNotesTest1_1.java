...
public class AppTestMigrator_swiftNotesTest1_1 {
    ...
    public void apptestmigrator_swiftnotestest1_1() {
        ...
        onView(withId(R.id.note_item_$_textview_title)).check(matches(withText("Title1")));
        
        onView(withId(R.id.note_item_$_textview_content)).check(matches(withText("Note1")));
