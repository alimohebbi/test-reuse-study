...
public class AppTestMigrator_shoppingListTest11_2 {
    ...
    public void apptestmigrator_shoppinglisttest11_2() {
        ...
        onView(withId(R.id.edUnitValue)).perform(replaceText("list1"), closeSoftKeyboard());
        ...
        onView(withXPath("/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout[2]/android.widget.TableLayout")).check(matches(isDisplayed()));
