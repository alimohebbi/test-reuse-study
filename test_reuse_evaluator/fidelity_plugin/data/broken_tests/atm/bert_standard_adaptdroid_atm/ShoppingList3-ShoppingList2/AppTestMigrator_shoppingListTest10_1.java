...
public class AppTestMigrator_shoppingListTest10_1 {
    ...
    public void apptestmigrator_shoppinglisttest10_1() {
        ...
        onView(withXPath("/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.ListView/android.widget.LinearLayout[3]/android.widget.RelativeLayout/android.widget.TextView")).check(matches(withText("Settings")));
