...
public class AppTestMigrator_noteTakingTest1_1 {
    ...
    public void apptestmigrator_notetakingtest1_1() {
        ...
        onView(withId(R.id.note_content)).perform(replaceText("to-do"), closeSoftKeyboard());
        
        onView(withId(R.id.edit_note_title)).perform(replaceText("Go shopping"), closeSoftKeyboard());
        
        pressBack();
        
        onView(withId(R.id.note_extra)).check(matches(withText("Last modified: 4/13/2022, 6:45 PM")));
