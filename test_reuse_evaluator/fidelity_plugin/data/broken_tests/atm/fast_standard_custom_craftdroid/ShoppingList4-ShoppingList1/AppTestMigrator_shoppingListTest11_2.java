...
public class AppTestMigrator_shoppingListTest11_2 {
    ...
    public void apptestmigrator_shoppinglisttest11_2() {
        ...
        onView(withId(R.id.itemsCountTextView)).check(matches(allOf(withText("Your shopping lists"), isDisplayed(), isEnabled())));
        ...
        onView(withXPath("/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup")).check(matches(allOf(isDisplayed(), withText("pcs"), isEnabled())));
