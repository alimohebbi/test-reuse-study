...
public class AppTestMigrator_noteTakingTest1_1 {
    ...
    public void apptestmigrator_notetakingtest1_1() {
        ...
        onView(withId(R.id.edit_note_title)).perform(replaceText("to-do"), closeSoftKeyboard());
        
        onView(withId(R.id.note_content)).perform(replaceText("Go shopping"), closeSoftKeyboard());
        
        pressBack();
        
        onView(withId(R.id.note_title)).check(matches(withText("to-do")));
