...
public class AppTestMigrator_shoppingListTest11_2 {
    ...
    public void apptestmigrator_shoppinglisttest11_2() {
        ...
        onView(withXPath("/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.support.v4.widget.DrawerLayout/android.view.ViewGroup")).check(matches(allOf(withText("Your shopping lists"), isDisplayed(), isEnabled())));
        ...
        onView(withId(R.id.item_quantity_edit_text)).perform(replaceText("item1"), closeSoftKeyboard());
        
        onView(withId(R.id.addShoppingListButton)).perform(click());
        
        onView(withId(R.id.text_quantity_textView)).check(matches(allOf(isDisplayed(), withText("Quantity"), isEnabled())));
