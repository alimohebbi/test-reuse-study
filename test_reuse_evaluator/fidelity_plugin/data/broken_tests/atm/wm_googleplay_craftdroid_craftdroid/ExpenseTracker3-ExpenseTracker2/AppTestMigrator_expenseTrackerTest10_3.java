...
public class AppTestMigrator_expenseTrackerTest10_3 {
    ...
    public void apptestmigrator_expensetrackertest10_3() {
        ...
        onView(withId(R.id.save_expense)).check(matches(withText("04-01-2022")));
        
        onView(withId(R.id.expense_value)).perform(replaceText("uber"), closeSoftKeyboard());
        
        onView(withContentDescription("Navigate up")).perform(click());
        
        onView(withId(R.id.total_month)).check(matches(isDisplayed()));
        ...
        onView(withId(R.id.total_month_description)).check(matches(isDisplayed()));
