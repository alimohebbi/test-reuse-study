...
public class AppTestMigrator_shoppingListTest11_2 {
    ...
    public void apptestmigrator_shoppinglisttest11_2() {
        ...
        onView(allOf(withId(R.id.design_menu_item_text), withText("Tell a friend"))).perform(click());
        ...
        onView(withText("Your shopping lists")).check(matches(allOf(isDisplayed(), withText("Your shopping lists"), isEnabled())));
