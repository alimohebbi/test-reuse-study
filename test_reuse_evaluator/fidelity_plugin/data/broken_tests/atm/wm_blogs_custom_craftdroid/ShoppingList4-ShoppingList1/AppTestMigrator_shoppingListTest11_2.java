...
public class AppTestMigrator_shoppingListTest11_2 {
    ...
    public void apptestmigrator_shoppinglisttest11_2() {
        ...
        onView(withId(R.id.percentTextView)).check(matches(allOf(withText("list1"), isDisplayed(), isEnabled())));
        ...
        onView(withId(R.id.toolbar)).check(matches(allOf(isDisplayed(), isEnabled())));
