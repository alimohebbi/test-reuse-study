...
public class AppTestMigrator_noteTakingTest1_1 {
    ...
    public void apptestmigrator_notetakingtest1_1() {
        ...
        onView(withId(R.id.bodyEdit)).perform(replaceText("to-do"), closeSoftKeyboard());
        
        onView(withId(R.id.titleEdit)).perform(replaceText("Go shopping"), closeSoftKeyboard());
        
        pressBack();
        
        onView(withXPath("/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.ScrollView")).check(matches(withText("Yes")));
