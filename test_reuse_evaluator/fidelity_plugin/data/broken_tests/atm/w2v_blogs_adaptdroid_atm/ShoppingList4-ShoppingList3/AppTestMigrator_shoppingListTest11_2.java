...
public class AppTestMigrator_shoppingListTest11_2 {
    ...
    public void apptestmigrator_shoppinglisttest11_2() {
        ...
        onView(withText("Product checkboxes are shown on the right")).perform(click());
        
        onView(withText("Product checkboxes are shown on the left")).check(matches(allOf(withText("Product checkboxes are shown on the left"), isDisplayed(), isEnabled())));
        
        onView(withText("Move checked products to the end of the list is on")).perform(click());
        
        onView(withText("Statistics will be "enabled" per default when creating a new list.")).perform(click());
        
        onView(withText("Move checked products to the end of the list is off")).perform(click());
        
        onView(withText("Statistics will be "disabled" per default when creating a new list.")).perform(click());
        
        onView(withXPath("/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.support.v4.widget.DrawerLayout/android.view.ViewGroup/android.widget.LinearLayout[2]/android.widget.LinearLayout/android.widget.ListView/android.widget.LinearLayout[2]/android.widget.RelativeLayout/android.widget.TextView")).check(matches(allOf(isDisplayed(), withText("Move Checked Products"), isEnabled())));
