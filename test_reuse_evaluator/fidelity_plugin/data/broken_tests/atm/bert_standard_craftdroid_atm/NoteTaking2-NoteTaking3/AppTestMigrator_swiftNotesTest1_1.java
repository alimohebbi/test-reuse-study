...
public class AppTestMigrator_swiftNotesTest1_1 {
    ...
    public void apptestmigrator_swiftnotestest1_1() {
        onView(allOf(withId(R.id.note_extra), withText("Last modified: 4/4/2022, 2:07 AM"))).check(matches(withText("Last modified: 4/4/2022, 2:07 AM")));
        
        onView(allOf(withId(R.id.note_title), withText("Note1"))).check(matches(withText("Note1")));
